'use client'
import Style from "@/app/all_resume_templates/elements/Summary/about_2/about_2.module.css";
...
export default function Summary(props) {
    ...
    let [content, setContent] = useState([
        ...
        {
            "summary": "You describe yourself in a resume by using action words, industry-specific skills, and powerful adjectives throughout it. By making the most of the words you use to describe your goals and accomplishments.",
        },
    ])
        ...
        <div className={Style.container} >
            <div className={Style.title_wrap} style={{ color: props.color_change }}>
                <div className={Style.title}>
                    <div className={Style.icon} ><MdAccountBox size={35} /></div>
